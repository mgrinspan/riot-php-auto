...
/**
 * MatchV5MetadataTimeLineDto Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MatchV5MetadataTimeLineDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'match-v5.MetadataTimeLineDto';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['data_version'] === null) {
            $invalidProperties[] = "'data_version' can't be null";
        }
     ...
     * Sets data_version
     *
     * @param string $data_version Match data version.
     *
     * @return $this
     */
     ...
     * Sets participants
     *
     * @param string[] $participants A list of participant PUUIDs.
     *
     * @return $this
     */
