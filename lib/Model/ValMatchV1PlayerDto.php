...
/**
 * ValMatchV1PlayerDto Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ValMatchV1PlayerDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'val-match-v1.PlayerDto';
    ...
    protected static $swaggerTypes = [
        ...
        'party_id' => 'string',
        'character_id' => 'string',
        'stats' => '\Swagger\Client\Model\ValMatchV1PlayerStatsDto',
    ...
    protected static $setters = [
        ...
        'is_observer' => 'setIsObserver',
        'account_level' => 'setAccountLevel'
    ];
    ...
    protected static $getters = [
        ...
        'is_observer' => 'getIsObserver',
        'account_level' => 'getAccountLevel'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_observer'] = isset($data['is_observer']) ? $data['is_observer'] : null;
        $this->container['account_level'] = isset($data['account_level']) ? $data['account_level'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_observer'] === null) {
            $invalidProperties[] = "'is_observer' can't be null";
        }
        if ($this->container['account_level'] === null) {
            $invalidProperties[] = "'account_level' can't be null";
        }
     ...
     * Gets stats
     *
     * @return \Swagger\Client\Model\ValMatchV1PlayerStatsDto
     */
     ...
     * Sets stats
     *
     * @param \Swagger\Client\Model\ValMatchV1PlayerStatsDto $stats stats
     *
     * @return $this
     */
    ...
    {
        return $this->container['is_observer'];
    }

    /**
     * Sets is_observer
     *
     * @param bool $is_observer is_observer
     *
     * @return $this
     */
    public function setIsObserver($is_observer)
    {
        $this->container['is_observer'] = $is_observer;
    ...
    {
        return $this->container['account_level'];
    }

    /**
     * Sets account_level
     *
     * @param int $account_level account_level
     *
     * @return $this
     */
    public function setAccountLevel($account_level)
    {
        $this->container['account_level'] = $account_level;
