...
/**
 * ValConsoleMatchV1AbilityDto Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ValConsoleMatchV1AbilityDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'val-console-match-v1.AbilityDto';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['grenade_effects'] === null) {
            $invalidProperties[] = "'grenade_effects' can't be null";
        }
        if ($this->container['ability1_effects'] === null) {
            $invalidProperties[] = "'ability1_effects' can't be null";
        }
        if ($this->container['ability2_effects'] === null) {
            $invalidProperties[] = "'ability2_effects' can't be null";
        }
        if ($this->container['ultimate_effects'] === null) {
            $invalidProperties[] = "'ultimate_effects' can't be null";
        }
