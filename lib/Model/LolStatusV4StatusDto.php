...
/**
 * LolStatusV4StatusDto Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LolStatusV4StatusDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'lol-status-v4.StatusDto';
    ...
    protected static $swaggerTypes = [
        ...
        'titles' => '\Swagger\Client\Model\LolStatusV4ContentDto[]',
        'updates' => '\Swagger\Client\Model\LolStatusV4UpdateDto[]',
        'created_at' => 'string',
        'archive_at' => 'string',
        'updated_at' => 'string',
        'platforms' => 'string[]'
    ...
    {
        $allowedValues = $this->getMaintenanceStatusAllowableValues();
        if (!is_null($maintenance_status) && !in_array($maintenance_status, $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getIncidentSeverityAllowableValues();
        if (!is_null($incident_severity) && !in_array($incident_severity, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'incident_severity', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Sets titles
     *
     * @param \Swagger\Client\Model\LolStatusV4ContentDto[] $titles titles
     *
     * @return $this
     */
     ...
     * Gets updates
     *
     * @return \Swagger\Client\Model\LolStatusV4UpdateDto[]
     */
     ...
     * Sets updates
     *
     * @param \Swagger\Client\Model\LolStatusV4UpdateDto[] $updates updates
     *
     * @return $this
     */
