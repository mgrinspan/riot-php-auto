...
/**
 * AccountV1AccountDto Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountV1AccountDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'account-v1.AccountDto';
     ...
     * Sets game_name
     *
     * @param string $game_name This field may be excluded from the response if the account doesn't have a gameName.
     *
     * @return $this
     */
     ...
     * Sets tag_line
     *
     * @param string $tag_line This field may be excluded from the response if the account doesn't have a tagLine.
     *
     * @return $this
     */
