...
/**
 * TftLeagueV1LeagueListDTO Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TftLeagueV1LeagueListDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tft-league-v1.LeagueListDTO';
    ...
    protected static $swaggerTypes = [
        'league_id' => 'string',
        'entries' => '\Swagger\Client\Model\TftLeagueV1LeagueItemDTO[]',
        'tier' => 'string',
        'name' => 'string',
        'queue' => 'string'
    ];
     ...
     * Gets entries
     *
     * @return \Swagger\Client\Model\TftLeagueV1LeagueItemDTO[]
     */
     ...
     * Sets entries
     *
     * @param \Swagger\Client\Model\TftLeagueV1LeagueItemDTO[] $entries entries
     *
     * @return $this
     */
