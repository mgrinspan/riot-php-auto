...
/**
 * TournamentV5TournamentCodeParametersV5 Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TournamentV5TournamentCodeParametersV5 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tournament-v5.TournamentCodeParametersV5';
    ...
    public function setTeamSize($team_size)
    {
        ...
        if (($team_size > 5)) {
            throw new \InvalidArgumentException('invalid value for $team_size when calling TournamentV5TournamentCodeParametersV5., must be smaller than or equal to 5.');
        }
        if (($team_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $team_size when calling TournamentV5TournamentCodeParametersV5., must be bigger than or equal to 1.');
        }
