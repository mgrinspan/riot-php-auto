...
/**
 * TftSummonerV1SummonerDTO Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TftSummonerV1SummonerDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tft-summoner-v1.SummonerDTO';
     ...
     * Sets revision_date
     *
     * @param int $revision_date Date summoner was last modified specified as epoch milliseconds. The following events will update this timestamp: summoner name change, summoner level change, or profile icon change.
     *
     * @return $this
     */
