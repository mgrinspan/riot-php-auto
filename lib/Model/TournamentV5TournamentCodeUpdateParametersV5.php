...
/**
 * TournamentV5TournamentCodeUpdateParametersV5 Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TournamentV5TournamentCodeUpdateParametersV5 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tournament-v5.TournamentCodeUpdateParametersV5';
     ...
     * Sets pick_type
     *
     * @param string $pick_type The pick type              (Legal values:  BLIND_PICK,  DRAFT_MODE,  ALL_RANDOM,  TOURNAMENT_DRAFT)
     *
     * @return $this
     */
     ...
     * Sets map_type
     *
     * @param string $map_type The map type              (Legal values:  SUMMONERS_RIFT,  HOWLING_ABYSS)
     *
     * @return $this
     */
     ...
     * Sets spectator_type
     *
     * @param string $spectator_type The spectator type              (Legal values:  NONE,  LOBBYONLY,  ALL)
     *
     * @return $this
     */
