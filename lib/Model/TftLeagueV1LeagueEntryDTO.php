...
/**
 * TftLeagueV1LeagueEntryDTO Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TftLeagueV1LeagueEntryDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tft-league-v1.LeagueEntryDTO';
    ...
    protected static $swaggerTypes = [
        ...
        'fresh_blood' => 'bool',
        'inactive' => 'bool',
        'mini_series' => '\Swagger\Client\Model\TftLeagueV1MiniSeriesDTO'
    ];
     ...
     * Sets league_id
     *
     * @param string $league_id Not included for the RANKED_TFT_TURBO queueType.
     *
     * @return $this
     */
     ...
     * Sets rated_tier
     *
     * @param string $rated_tier Only included for the RANKED_TFT_TURBO queueType.              (Legal values:  ORANGE,  PURPLE,  BLUE,  GREEN,  GRAY)
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getRatedTierAllowableValues();
        if (!is_null($rated_tier) && !in_array($rated_tier, $allowedValues, true)) {
     ...
     * Sets rated_rating
     *
     * @param int $rated_rating Only included for the RANKED_TFT_TURBO queueType.
     *
     * @return $this
     */
     ...
     * Sets tier
     *
     * @param string $tier Not included for the RANKED_TFT_TURBO queueType.
     *
     * @return $this
     */
     ...
     * Sets rank
     *
     * @param string $rank The player's division within a tier. Not included for the RANKED_TFT_TURBO queueType.
     *
     * @return $this
     */
     ...
     * Sets league_points
     *
     * @param int $league_points Not included for the RANKED_TFT_TURBO queueType.
     *
     * @return $this
     */
     ...
     * Sets losses
     *
     * @param int $losses Second through eighth placement.
     *
     * @return $this
     */
     ...
     * Sets hot_streak
     *
     * @param bool $hot_streak Not included for the RANKED_TFT_TURBO queueType.
     *
     * @return $this
     */
     ...
     * Sets veteran
     *
     * @param bool $veteran Not included for the RANKED_TFT_TURBO queueType.
     *
     * @return $this
     */
     ...
     * Sets fresh_blood
     *
     * @param bool $fresh_blood Not included for the RANKED_TFT_TURBO queueType.
     *
     * @return $this
     */
     ...
     * Sets inactive
     *
     * @param bool $inactive Not included for the RANKED_TFT_TURBO queueType.
     *
     * @return $this
     */
     ...
     * Gets mini_series
     *
     * @return \Swagger\Client\Model\TftLeagueV1MiniSeriesDTO
     */
     ...
     * Sets mini_series
     *
     * @param \Swagger\Client\Model\TftLeagueV1MiniSeriesDTO $mini_series Not included for the RANKED_TFT_TURBO queueType.
     *
     * @return $this
     */
